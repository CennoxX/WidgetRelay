package com.cennoxx.widgetrelay.tasker.launchactivity
...
import com.cennoxx.widgetrelay.tasker.ActivityConfigTaskerNoOutputOrInput
...
class LaunchActivityRunner : TaskerPluginRunnerActionNoOutputOrInput() {
    override fun run(context: Context, input: TaskerInput<Unit>): TaskerPluginResult<Unit> {
        ...
        return TaskerPluginResultSucess(callbackUri = Uri.parse("widgetrelay://fromplugin"))
    }
}
